...
Revision ID: e9899ba49fa2
Revises: 
Create Date: 2025-05-13 16:57:14.542435
...
def upgrade() -> None:
    ...
    # op.drop_index('ix_chatbot_doc_chunks_id', table_name='chatbot_doc_chunks')
    # op.drop_table('chatbot_doc_chunks')
    # op.drop_index('ix_activity_logs_id', table_name='activity_logs')
    # op.drop_table('activity_logs')
    # op.drop_index('ix_users_id', table_name='users_old')
...
def downgrade() -> None:
    ...
    sa.Column('log_activity', mysql.VARCHAR(length=500), nullable=False),
    sa.Column('created_at', mysql.DATETIME(), nullable=True),
    sa.Column('updated_at', mysql.DATETIME(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_general_ci',
    ...
    op.create_index('ix_chatbot_doc_chunks_id', 'chatbot_doc_chunks', ['id'], unique=False)
    # ### end Alembic commands ###
